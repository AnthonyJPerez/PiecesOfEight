...
<h2> Custom Listings </h2>


<?php 

$this->widget('zii.widgets.CListView', array(
	'dataProvider'=>$_CustomProducts,
	'itemView'=>'_view',
...
<?php
	...
	// temporary: don't show it at all
	$dontshow = true;
	if (!$dontshow && defined('YII_DEBUG') && constant('YII_DEBUG') != false)
	{
?>
